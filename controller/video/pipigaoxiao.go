...
func (p piPiGaoXiao) parseVideoID(videoId string) (*public.VideoParseInfo, error) {
	...
	parseRes := &public.VideoParseInfo{
		Title:    title,
		VideoUrl: videoUrl,
		CoverUrl: cover,
	}
...
func (p piPiGaoXiao) parseShareUrl(shareUrl string) (*public.VideoParseInfo, error) {
